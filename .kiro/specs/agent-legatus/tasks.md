...
- [ ] 12. Implement Centurion class
  ...
  - [x] 12.7 Write property tests for Centurion
    - **Property 9: Dependency Execution Order**
    - **Validates: Requirements 2.5**

- [x] 13. Implement Legatus orchestrator
  - [x] 13.1 Create Legatus class
    - Implement __init__ with config and event_bus
    - Implement add_centurion() method
    - Implement get_status() method
    - _Requirements: 1.1-1.8_
  
  - [x] 13.2 Implement workflow execution
  ...
  - [x] 13.3 Implement workflow cancellation
  ...
  - [x] 13.4 Implement workflow timeout enforcement
  ...
  - [x] 13.5 Write property tests for Legatus
    - **Property 1: Workflow Execution Completeness**
    - **Property 2: Workflow Event Lifecycle**
    - **Validates: Requirements 1.1-1.6**

- [x] 14. Checkpoint - Core framework complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 15. Implement MemoryManager and memory backends
  - [x] 15.1 Create MemoryBackend abstract class
  ...
  - [x] 15.2 Implement MemoryManager
  ...
  - [x] 15.3 Implement in-memory MemoryBackend
...
- [x] 17. Implement observability layer
  ...
  - [x] 17.3 Implement OpenTelemetry integration
    - Set up OpenTelemetry tracing
    - Propagate trace_id and correlation_id through events
    - Export traces in OpenTelemetry format
    - _Requirements: 16.7, 16.8_
  
  - [x] 17.4 Implement Prometheus metrics export
    - Export metrics in Prometheus exposition format
    - Include workflow, step, and provider metrics
    - _Requirements: 16.6_

- [x] 18. Implement provider adapters (minimal implementations)
  - [x] 18.1 Implement LangGraph provider
  ...
  - [x] 18.2 Implement mock provider for testing
    - Create MockProvider class extending BaseProvider
    - Implement deterministic behavior for testing
    - Support all capabilities
    - _Requirements: 3.1-3.8_
  
  - [x] 18.3 Write property tests for provider implementations
    - **Property 28: Provider Capability Enforcement**
    - **Validates: Requirements 24.4**

- [x] 19. Implement additional state backends
  - [x] 19.1 Implement Redis StateBackend
  ...
  - [x] 19.2 Implement Postgres StateBackend
...
- [x] 23. Implement security features
  ...
  - [x] 23.2 Implement secure API communication
    - Use HTTPS with certificate validation for all external calls
    - Support custom CA certificates
    - _Requirements: 20.3_
  
  - [x] 23.3 Implement access control and audit logging
...
- [x] 24. Implement error handling and recovery
  ...
  - [x] 24.2 Implement error recovery mechanisms
